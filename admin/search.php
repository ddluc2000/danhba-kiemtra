                ...
                <div class="wrapper">
                    <div class="row row1">
                        <?php
                            ...
                            $sql2 = "SELECT * FROM tbdonvi WHERE donviName LIKE '%$search%' OR donviDescription LIKE '%$search%'";
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        if(mysqli_num_rows($result)>0){
                                            ...
                                            $iddonvi1 = $row2['id'];
                                            $sql3 = "SELECT * FROM tbcanbo WHERE idDonvi = $iddonvi1";
                                            $result3 = mysqli_query($conn,$sql3);
                                            while($row3 = mysqli_fetch_assoc($result3)){
                                            ?>
                                                <tr>
                                                    <th scope="row"><?php echo $i ;?></th>
                                                    <td><?php echo $row3['canboName'];?></td>
                                                    <td><?php echo $row3['canboChucvu'];?></td>
                                                    <td><?php echo $row3['canboDtcq'];?></td>
                                                    <td><?php echo $row3['canboEmail'];?></td>
                                                    <td><?php echo $row3['canboDidong'];?></td>
                                                    <td><?php echo $row2['donviName'];?></td>
                                                </tr> 
                                        <?php
                                                $i++;
                                            }
